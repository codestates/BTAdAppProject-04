...
type PoolFormTokenButtonProps = {
  initial?: boolean;
  select(val: boolean): void;
  selected: SelectedToken;
};

const PoolFormTokenButton = ({
  initial,
  select,
  selected,
}: PoolFormTokenButtonProps): JSX.Element => {
  ...
  return (
    <div
      className={`w-full flex whitespace-nowrap rounded-3xl p-2 cursor-pointer ${
        initial
...
const styles = {
  changeLight: "bg-orange-500 text-gray-200 ",
  changeDark: "bg-blue-500 text-gray-200",
};

export default PoolFormTokenButton;
